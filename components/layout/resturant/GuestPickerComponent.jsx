    ...
    return (
        <View className='flex flex-row items-center rounded-lg text-white text-base'>
            <TouchableOpacity onPress={decrement} className='rounded'>
                <Text className='text-white px-3 text-lg border rounded-l-lg border-[#f49b33]' >-</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={increment} className='rounded'>
                <Text className='text-white  px-3 text-lg border rounded-r-lg border-[#f49b33]' >+</Text>
            </TouchableOpacity>
        </View>
    )
}
